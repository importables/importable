...
import { rollup, defineInputOptions, defineOutputOptions, defineWatchOptions, getPath, mkdir, rm, watch, writeFile } from './rollup.js'
...
const watchOptions = defineWatchOptions({
	...inputOptions,
